...
<div class="container mt-3 ">
    <div class="row"> 
        <div class="col-md-6  text-white rounded">
           <form action='/bulletins/ajout' method="POST">
            <h3 class="inscrit text-white">Veuillez ajouter un bulletin de paie</h3><hr>
            @csrf
                <div class="mb-3">
                    <label for="exampleInputNom" class="form-label">Date de paiement</label>
                    <input type="date" name="nom" class="form-control" id="exampleInputNom" aria-describedby="emailHelp"  required>
                </div>
