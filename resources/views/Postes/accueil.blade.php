...
<div class="container mt-3 ">
    <div class="row"> 
        <div class="col-md-6  text-white rounded">
           <form action='/postes/enregistrement' method="POST">
            <h2 class="inscrit text-white">Veuillez ajouter un poste</h2><hr>
            @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleInputNom" class="form-label">Description</label>
                    <input type="text" name="nom" class="form-control" id="exampleInputNom" aria-describedby="emailHelp"  required>
                </div>
