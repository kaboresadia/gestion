...
<div class="container mt-3 ">
    <div class="row">
        <div class="col-md-6  text-white rounded">
            <form action='/salaires/ajouter' method="POST">
                <h2 class="inscrit text-white">Veuillez ajouter un salaire</h2><hr>
                @csrf
                <div class="mb-3">
                    <label for="exampleInputNom" class="form-label">Nom du salaire</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="montant" class="form-control" id="exampleInputMontant" aria-describedby="emailHelp" required>
                </div>
